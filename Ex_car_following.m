...
figure;  
subplot(3,1,1); plot(Time,x(1,:)); xlabel('time (s)'); ylabel('Spacing error'); title('IOP')
subplot(3,1,2); plot(Time,x(2,:)); xlabel('time (s)'); ylabel('Velocity error');
subplot(3,1,3); plot(Time,x(3,:)); xlabel('time (s)'); ylabel('Acceleration');
...
figure; subplot(2,1,1); plot(Time,u); xlabel('time (s)'); ylabel('Control input'); title('IOP reduction')
           subplot(2,1,2); plot(Time,max(abs(kesi))); xlabel('time (s)'); ylabel('internal state');
figure;  
subplot(3,1,1); plot(Time,x(1,:)); xlabel('time (s)'); ylabel('Spacing error'); title('IOP reduction')
subplot(3,1,2); plot(Time,x(2,:)); xlabel('time (s)'); ylabel('Velocity error');
subplot(3,1,3); plot(Time,x(3,:)); xlabel('time (s)'); ylabel('Acceleration');
...
figure; subplot(2,1,1); plot(Time,u); xlabel('time (s)'); ylabel('Control input'); title('SLS')
           subplot(2,1,2); plot(Time,max(abs(kesi))); xlabel('time (s)'); ylabel('internal state');
figure; 
subplot(3,1,1); plot(Time,x(1,:)); xlabel('time (s)'); ylabel('Spacing error');  title('SLS')
subplot(3,1,2); plot(Time,x(2,:)); xlabel('time (s)'); ylabel('Velocity error');
subplot(3,1,3); plot(Time,x(3,:)); xlabel('time (s)'); ylabel('Acceleration');
...
figure; subplot(2,1,1); plot(Time,u); xlabel('time (s)'); ylabel('Control input'); title('SLS reduction')
           subplot(2,1,2); plot(Time,max(abs(kesi))); xlabel('time (s)'); ylabel('internal state');
figure;  
subplot(3,1,1); plot(Time,x(1,:)); xlabel('time (s)'); ylabel('Spacing error'); title('SLS reduction')
subplot(3,1,2); plot(Time,x(2,:)); xlabel('time (s)'); ylabel('Velocity error');
subplot(3,1,3); plot(Time,x(3,:)); xlabel('time (s)'); ylabel('Acceleration');


%% Optimal controller   -- this behavior is very strange -- couldn't understand
% 
% [x,y,u] = dynsim(G,K,deltaT,dx,dy,du,T,x0);
% 
% % figure
% Time = (1:Tn)*deltaT;
% figure(3); plot(Time,u); xlabel('time (s)'); ylabel('Control input');
% figure(4); 
% subplot(3,1,1); plot(Time,x(1,:)); xlabel('time (s)'); ylabel('Spacing error');
% subplot(3,1,2); plot(Time,x(2,:)); xlabel('time (s)'); ylabel('Velocity error');
% subplot(3,1,3); plot(Time,x(3,:)); xlabel('time (s)'); ylabel('Acceleration');
